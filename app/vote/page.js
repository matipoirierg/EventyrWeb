...
export default function Vote() {
  return (
    <div className="min-h-screen p-8 flex items-center">
      <div className="max-w-4xl mx-auto bg-gradient-to-l from-slate-500 to-gray-700 rounded-3xl shadow-2xl overflow-hidden outline outline-indigo-800">
        <div className="p-8">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {voteLinks.map((link) => (
              ...
              >
                <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl p-6 shadow-lg transform transition duration-300 ease-in-out hover:-translate-y-2 hover:shadow-xl outline outline-blue-600">
